        ...
        <form onSubmit={this.submitForm.bind(this)} ref={form => { this.form = form }}>
          ...
          <div className='modal-card'>
            <header className='modal-card-head'>
              <p className='modal-card-title'>Creating a project</p>
            ...
            <section className='modal-card-body'>
              ...
              <p className='control'>
                <input className='input' ref={nameInput => { this.nameInput = nameInput }}
                  type='text' placeholder='Project name' required={true} />
              </p>
              <label className='label'>Description</label>
              <p className='control'>
                <textarea className='textarea' placeholder='Project Description'
